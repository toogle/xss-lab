					...
					<div class="panel panel-default">
						...
						<div id="hint" class="panel-body collapse">
							<p>
								...
								комментарии. Результатом реализации XSS-инъекции будет сохранение вредосного кода 
								на сервере, который будет выполняться во всех ответах на один и тот же клиентский запрос.
							</p>

							<p>
								Бывает так, что в случае взаимодействия с базой данных сайт корректно обрабатывает 
								пользовательский ввод перед его добавлением в базу, однако не делает этого перед его
								извлечением оттуда. В этом задании следует обратить внимание на то, что при 
