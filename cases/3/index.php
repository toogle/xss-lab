					...
					<div class="panel panel-default">
						...
						<div id="hint" class="panel-body collapse">
							...
							<p>
								...
								(DOM-based), достаточно того, чтобы какой-нибудь сценарий JavaScript на странице 
								имел доступ к параметру URL и формировал страницу, задействуя его (без необходимых 
								проверок). Такое может быть, например, при использовании локальных ссылок для навигации 
								по текущей странице.
							</p>
						</div>
					</div>
